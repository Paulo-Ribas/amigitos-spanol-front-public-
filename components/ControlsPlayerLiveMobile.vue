    ...
    <div class="mobile-controls-container" @click="toggleControll" @touchend="stopAllDraggings()" @mouseup.stop="stopAllDraggings" @mousemove.stop="draggingVolume($event), draggingBar($event)" @touchmove.stop="draggingVolume($event), draggingBar($event)">
        ...
        <div class="controls" @keydown="keysEvents">
            ...
            <div class="container-btns">
                ...
                <div class="volume"  @mousedown="setDragging($event, 'volume')" @click="setVolume($event)" @mousemove="draggingVolume($event)" @touchstart="setDragging($event, 'volume')" @touchmove="draggingVolume($event)" @mouseleave="stopDraggingVolume" @touchend="stopDraggingVolume" >
                    <div id="volume-bar">
                        <div class="ball"></div>
                    </div>
                </div>
